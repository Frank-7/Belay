...
setlocal
cd /d "%~dp0"
echo Belay Payment Mission MVP
...
:bundled
"%BELAY_DEMO_PYTHON%" -m purchase_simulator.server --port 8777 --data-dir .belay-purchase-simulator/mission-v1
goto finished

:launcher
py -3 -m purchase_simulator.server --port 8777 --data-dir .belay-purchase-simulator/mission-v1
goto finished

:standard
python -m purchase_simulator.server --port 8777 --data-dir .belay-purchase-simulator/mission-v1
